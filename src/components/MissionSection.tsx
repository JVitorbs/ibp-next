...
export default function MissionSection() {
  return (
    <section id="missao" className="py-16 md:py-24 px-4 bg-background">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <ScrollReveal direction="left" delay={0}>
            <Card>
              ...
              <CardContent>
                Ser uma igreja vibrante e relevante que impacta positivamente a sociedade e transforma comunidades através do Evangelho.
              </CardContent>
            </Card>
          </ScrollReveal>
